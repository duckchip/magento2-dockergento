...
MYSQL_USER=${ANSWER_MYSQL_USER:-${MYSQL_USER}}

read -p "Database password: [${MYSQL_PASSWORD}] " ANSWER_MYSQL_PASSWORD
MYSQL_PASSWORD=${ANSWER_MYSQL_PASSWORD:-${MYSQL_PASSWORD}}

read -p "Database root password: [${MYSQL_ROOT_PASSWORD}] " ANSWER_MYSQL_ROOT_PASSWORD
MYSQL_ROOT_PASSWORD=${ANSWER_MYSQL_ROOT_PASSWORD:-${MYSQL_ROOT_PASSWORD}}
